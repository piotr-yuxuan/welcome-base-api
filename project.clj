(defproject com.github.piotr-yuxuan/welcome-base-api (-> "./resources/welcome-base-api.version" slurp .trim)
  ...
  :dependencies [;; Core business domain
                 ...
                 ;; HTTP
                 [http-kit "2.7.0-alpha4"] ; http server
                 ...
                 [com.cognitect.aws/api "0.8.656"] ; Hard-patch vulnerable transitive dependency
                 ...
                 [org.clojure/clojure "1.12.0-alpha2"] ; The language itself
