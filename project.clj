(defproject com.github.piotr-yuxuan/welcome-base-api (-> "./resources/welcome-base-api.version" slurp .trim)
  ...
  :dependencies [;; Core business domain
                 ...
                 ;; HTTP
                 [http-kit "2.8.0"] ; http server
                 [metosin/reitit "0.7.0" :exclusions [metosin/malli]] ; Router for Clojure(Script)
                 ...
                 [com.cognitect.aws/api "0.8.692"] ; Hard-patch vulnerable transitive dependency
                 ...
                 [babashka/process "0.5.22"] ; Clojure wrapper for java.lang.ProcessBuilder
                 [juji/editscript "0.6.3"] ; A diff library for Clojure/ClojureScript data structures
                 [camel-snake-kebab "0.4.3"] ; case manipulation
                 [com.xtdb/xtdb-core "1.24.3" :exclusions [org.clojure/data.json org.clojure/tools.reader]] ; Database

                 ;; Language constructs and utilities
                 [org.clojure/clojure "1.12.0-alpha12"] ; The language itself
                 [org.clojure/core.cache "1.1.234"] ; Caching logic
  ...
  :profiles {:github {:github/topics ["clojure" "api" "example" "exchange" "finance" "fintech" "market"
             ...
             :dev {:global-vars {*warn-on-reflection* true}
                   ...
                   :dependencies [[ring/ring-devel "2.0.0-alpha-1" :exclusions [crypto-random commons-io]] ; `wrap-reload` ring middleware
                                  ...
                                  [com.clojure-goes-fast/clj-async-profiler "1.2.2"] ; Sampling CPU and HEAP profiler for Clojure featuring AsyncGetCallTrace + perf_events
